...
namespace BochaStoreAPI.Controllers
{
    ...
    public class UsuariosController : ControllerBase
    {
        ...
        public UsuariosController(ProductoDbContext db, IConfiguration configuration)
        {
            _db = db;
        ...
        public async Task<IActionResult> Editar([FromBody] UserInputModel usuario)
        {
            ...
            Usuario usuarioEncontrado = await _db.Usuarios.FirstOrDefaultAsync(x => x.IdUsuario == userId);
            ...
            bool usernameExiste = await _db.Usuarios.AnyAsync(x => x.Username == usuario.Username && x.IdUsuario != userId);
        ...
        public async Task<IActionResult> GetPerfil()
        {
            ...
            // Se busca el usuario en la base de datos
            Usuario usuario = await _db.Usuarios.FirstOrDefaultAsync(x => x.IdUsuario == userId);
